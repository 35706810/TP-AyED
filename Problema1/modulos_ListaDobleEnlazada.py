...
#para probar mi codigo
"""
mi_lista = ListaDobleEnlazada()

# Insertar elementos en posiciones específicas
mi_lista.insertar(1,0)  # Insertar 1 al principio
mi_lista.insertar(3,1)  # Insertar 3 en la segunda posición
mi_lista.insertar(2,1)  # Insertar 2 en la segunda posición
mi_lista.insertar(4)      # Insertar 4 al final

# Imprimir la lista después de las inserciones
print("Lista después de las inserciones:", list(mi_lista))

# Extraer elementos en posiciones específicas
elemento_extraido_1 = mi_lista.extraer(1)  # Extraer el elemento en la segunda posición
elemento_extraido_2 = mi_lista.extraer(-1)  # Extraer el último elemento

# Imprimir los elementos extraídos y la lista después de las extracciones
print("Elemento extraído en la segunda posición:", elemento_extraido_1)
print("Elemento extraído en la última posición:", elemento_extraido_2)
print("Lista después de las extracciones:", list(mi_lista))"""